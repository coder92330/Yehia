...
return [
    ...
    */
    ...
    'path' => env('FILAMENT_PATH', 'tourguide'),
    ...
    */
    ...
    'resources' => [
        'namespace' => 'App\\TourGuide\\Resources',
        'path' => app_path('TourGuide/Resources'),
        'register' => [],
    ],
    ...
    */
    ...
    'widgets' => [
        ...
        'path' => app_path('TourGuide/Widgets'),
        'register' => [
            Widgets\AccountWidget::class,
            \App\TourGuide\Widgets\TourguideInformation::class
        ],
    ],
    ...
    */
    ...
    'livewire' => [
        'namespace' => 'App\\TourGuide',
        'path' => app_path('TourGuide'),
    ],
    ...
    */
    ...
    'auth' => [
        'guard' => env('FILAMENT_AUTH_GUARD', 'tourguide'),
        'pages' => [
            'login' => \App\Http\Livewire\TourGuideLogin::class,
        ],
    ],
    ...
    */
    ...
    'middleware' => [
        'auth' => [
            \App\TourGuide\Middleware\TourGuideMiddleware::class,
            \App\Http\Middleware\TourguideStyleMiddleware::class,
        ],
        'base' => [

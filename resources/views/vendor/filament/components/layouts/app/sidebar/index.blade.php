<aside
    ...
    @style([
        'background-color: #43425D' => config('filament-themes.color_public_path') === 'vendor/yepsua-filament-themes/css/violet.css',
        'color: #F0F0F7'            => config('filament-themes.color_public_path') === 'vendor/yepsua-filament-themes/css/violet.css',
    ])>
    <header @class([
    ...
    <nav class="flex-1 py-6 overflow-x-hidden overflow-y-auto filament-sidebar-nav">
        ...
        <ul class="px-6 space-y-6">
            @foreach ($navigation as $group)
                ...
                @if (! $loop->last)
                    <li @style([
                        'background-color: #A3A0FB' => config('filament-themes.color_public_path') === 'vendor/yepsua-filament-themes/css/violet.css',
                        'border-top-color: #A3A0FB' => config('filament-themes.color_public_path') === 'vendor/yepsua-filament-themes/css/violet.css',
                        ])>
                        <div @class([

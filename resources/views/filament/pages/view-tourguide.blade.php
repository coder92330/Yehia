    ...
    <section class="bg-white">
        <div class="bg-gray-50">
            <div class="mx-auto py-10 px-4 sm:py-6 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-8 items-center">
                        ...
                        <div class="flex flex-col space-y-3 w-full">
                            <div class="flex flex-row justify-between">
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <small class="text-gray-500 dark:text-gray-400 mt-2">{{ auth()->user()->favourites()->where([
                                                    'favouritable_id'   => $record->id,
                                                    'favouritable_type' => \App\Models\Tourguide::class
                                                ])->exists() ? 'Remove From Favorites' : 'Add To Favorites' }}</small>
                                </div>
                            </div>
                            ...
                            <div class="flex lg:flex-row flex-col lg:justify-between lg:space-y-0 space-y-4 pt-6">
                                <div class="flex flex-row space-x-2">
                                                ...
                                                <div class="p-6 flex flex-col space-y-4">
                                                    <x-filament::form
                                                        ...
                                                        <select id="type" name="type"
                                                            ...
                                                            <option value="tourguide">Private Chat With TourGuide
                                                            </option>
                                    ...
                                    {{--                                    <a href="{{ route('filament.pages.new-event', $record->id) }}"--}}

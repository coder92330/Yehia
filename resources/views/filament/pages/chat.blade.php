@if((!empty($rooms) && count($rooms) > 0) || !empty($search))
    <x-filament::page>
        <div class="grid grid-cols-11 bg-white">
            @include('filament.pages.admin.aside._chat_sidebar')
            @include('filament.pages.admin.aside._chat_body')
...
{{--                            </div>--}}
{{--                        @else--}}
{{--                            @php $receiver = $current_room->members()->whereMemberableType(\App\Models\Tourguide::class)->first()->memberable; @endphp--}}
{{--                            <div--}}
{{--                                class="flex sm:items-center justify-between lg:py-3 sm:pb-2 border-b-2 border-gray-200">--}}
{{--                                <div class="relative flex items-center space-x-4 ml-5">--}}
{{--                                    <div class="relative">--}}
...
{{--                                            </svg>--}}
{{--                                        </span>--}}
{{--                                        <img src="{{ $receiver->avatar }}" alt="{{ $receiver->full_name }}"--}}
{{--                                             class="w-10 lg:w-11 h-10 lg:h-11 rounded-full">--}}
{{--                                    </div>--}}
{{--                                    <div class="flex flex-col leading-tight">--}}
{{--                                        <div class="text-lg mt-1 flex items-center">--}}
{{--                                            <span class="text-gray-700 mr-3">{{ $receiver->full_name }}</span>--}}
{{--                                        </div>--}}
{{--                                        <div class="text-sm text-gray-600">--}}
...
{{--                            --}}{{--                                    <hr class="border-gray-300 w-1/2">--}}
{{--                            --}}{{--                                    <span--}}
{{--                            --}}{{--                                        class="text-gray-500 text-xs text-center mx-2">{{ $message->created_at->diffForHumans() }}</span>--}}
{{--                            --}}{{--                                    <hr class="border-gray-300 w-1/2">--}}
{{--                            --}}{{--                                </div>--}}
{{--                            --}}{{--                            @endif--}}
{{--                        </div>--}}
...
{{--                            <p class="text-gray-500">You can start a conversation with your tourguides by go to--}}
{{--                                tourguides--}}

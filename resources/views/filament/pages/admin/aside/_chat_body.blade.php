                    ...
                    @if(!is_null($current_room->event))
                        ...
                        <div class="flex flex-col leading-tight">
                            ...
                            <div class="text-sm text-gray-600">
                                <span
                                    class="mr-3">{{ __('attributes.chat.booked_by_agency', ['agency' => $current_room->event->company->name]) }}</span>
                            </div>
                        </div>
                    @else
                    ...
                    @else
                        <div class="chat-message">
                            <div class="flex items-start">
                                <img src="{{ $message->sender->memberable?->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode(__('attributes.chat.deleted_user')) . '&color=FFFFFF&background=111827' }}" alt="My profile"

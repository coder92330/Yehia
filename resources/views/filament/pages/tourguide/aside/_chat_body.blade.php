        ...
        <div
            ...
            <div
                ...
                <div class="relative flex items-center space-x-4 ml-5">
                    ...
                    @else
                        @php $receiver = $current_room->members()->whereNotTourguide()->whereIsEnabled(true)->first()->memberable; @endphp
                        <div class="relative">
            ...
            <div id="messages"
                ...
                @foreach ($messages as $message)
                    @if ($message->sender->memberable_type === auth('tourguide')->user()->getMorphClass())
                        <div class="chat-message mt-auto">
                            <div class="flex flex-row items-end justify-end">
                                ...
                                <img src="{{ auth('tourguide')->user()->avatar }}"
            ...
            <div class="border-t-2 mt-4 pt-4 mb-0 lg:mb-0">
                <div class="relative flex bg-gray-50">
                    <textarea rows="5"
                              ...
                              placeholder="{{ __('attributes.chat.type_message') }}"
                              wire:model.defer="msg" wire:keydown.enter="sendMsg"></textarea>
                    <div class="absolute right-1 bottom-2 items-center">
                        <button type="button" wire:click="sendMsg"
                            ...
                            <span class="font-semibold">{{ __('attributes.chat.send') }}</span>
    ...
    @else
        <div class="flex flex-col items-center justify-center h-screen border-l-2 border-gray-200"
            ...
            <div class="text-center">
                ...
                <p class="text-gray-500">{{ __('messages.chat.start_conversation_with_tourguide') }}</p>
            </div>
        </div>
    @endif
</div>
